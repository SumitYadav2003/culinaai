...
- Personalisation through ingredients, cuisine, diet, allergies and preferences
- Persistent storage using PostgreSQL
- User recipe management
- User evaluation through ratings and feedback
- AI refinement through recipe modification
- Explainability through original vs modified comparison
- Real email sharing
